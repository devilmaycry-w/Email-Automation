  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-200/50"
      >
        <div className="p-6 border-b border-gray-200/50 bg-gradient-to-r from-primary-50 to-accent-50">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Gmail Integration Setup</h2>
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center">
                ...
                <div className="ml-3 flex-1">
                  <p className={`font-medium ${currentStep >= step.id ? 'text-gray-800' : 'text-gray-400'}`}>
                    {step.title}
                  </p>
                  <p className="text-sm text-gray-500">{step.description}</p>
                </div>
                {index < steps.length - 1 && (
                  <div className={`w-12 h-0.5 mx-4 ${currentStep > step.id ? 'bg-gradient-to-r from-primary-500 to-accent-500' : 'bg-gray-200'}`} />
                )}
              </div>
            ))}
          </div>
          ...
          <div className="space-y-6">
              ...
              >
                <div className="bg-green-50 border border-green-200 rounded-2xl p-6 shadow-lg">
                  ...
                  <div className="bg-white rounded-xl p-4 border border-green-200">
                    <p className="text-sm text-gray-600 mb-2"><strong>Client ID:</strong></p>
                ...
                <div className="bg-blue-50 rounded-2xl p-6 shadow-lg">
                  <h4 className="font-semibold text-gray-800 mb-3">Authorized Redirect URIs</h4>
                  <p className="text-gray-600 text-sm mb-4">These redirect URIs are configured in your OAuth 2.0 setup:</p>
                  <div className="space-y-2">
                    {redirectURIs.map((uri, index) => (
                      <div key={index} className="flex items-center justify-between bg-white rounded-xl p-3 border shadow-sm">
                ...
                <div className="flex justify-end">
                  <motion.button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200"
                  >
            ...
            {currentStep === 2 && (
              ...
              >
                <div className="bg-green-50 rounded-2xl p-6 shadow-lg">
                  <h3 className="font-semibold text-gray-800 mb-4">Step 2: Enable Gmail API</h3>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-800">Navigate to API Library</p>
                        ...
                        <motion.a
                          ...
                          className="inline-flex items-center space-x-2 mt-2 text-blue-600 hover:text-blue-700 font-medium"
                        >
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-800">Search for Gmail API</p>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-800">Enable the API</p>
                ...
                <div className="flex justify-between">
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                  >
                    {isConnecting ? (
                      <>
            ...
            {currentStep === 3 && (
              ...
              >
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-800">Gmail Successfully Connected!</h3>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={onClose}
                  className="px-8 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200"
                >
                  Go to Dashboard
                </motion.button>
              </motion.div>
